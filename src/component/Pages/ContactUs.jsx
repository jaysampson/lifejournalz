      ...
      <section id="contact">
        <div className="container">
          <div className="text-center pt-5">
            ...
            <h2>Get in touch</h2>
            <p>
              Getting feedback from you is essential especially. Complete this
              form, thank you.
            </p>
          </div>
              ...
              <form action="">
                ...
                <div className="mb-4 input-group">
                  <input
                    ...
                    id="email"
                    placeholder="e.g cilla@example.com"
                  />
                ...
                <div class="form-check mb-4">
                  <input
                    ...
                    value="1"
                  />
                  <label for="updates" class="form-check-label">
          ...
          <div className="row justify-content-center">
            <div className="col-9">
              ...
              <p className="text-center">
                All the information you require regarding the product and
                billing.
              </p>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      Yes, you have 30 days to try us free. To get you up and
                      running as fast as possible, we'll give you a free,
                      individualized 30-minute onboarding call if you'd like.
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      Incidunt voluptas, porro repellat veritatis minus, rem nam
                      atque officia ipsa, voluptatem nihil odio nesciunt soluta
                      eius cum. Repudiandae esse doloremque facere!
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Sequi nemo ex impedit exercitationem aliquam similique
                      aliquid debitis, explicabo, pariatur natus beatae
                      accusantium in? Voluptatum accusantium, voluptatem officia
                      nihil quas vero.
                    </div>
                  </div>
                </div>
