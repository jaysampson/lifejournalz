    ...
    <>
        ...
        <div className="container p-5">
          ...
          <div className="row align-items-center justify-content-between">
            ...
            <div className="col-md p-5">
              ...
              <p>
                We guarantee that your data is encrypted, fully secured and not
      ...
      <div className="container px-4 py-5" id="custom-cards">
        <div className="text-center">
          ...
          <p className="mt-2 text-start text-md-center">
            Life Journalz provides all the tools you need to make a high-quality
            journal, including a place to keep track of the stories and
        ...
        <div className="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
          <div className="col">
            <div
              className="card card-cover overflow-hidden text-white  rounded-5 shadow-lg"
              style={{
          ...
          <div className="col">
            <div
              className="card card-cover overflow-hidden text-white  rounded-5 shadow-lg"
              style={{
                backgroundImage: "url('/image/AG.png')",
                backgroundPosition: "center center",
                backgroundSize: "cover",
                backgroundRepeat: "no-repeat",
                height: "400px",
          ...
          <div className="col">
            <div
              className="card card-cover  overflow-hidden text-white  rounded-5 shadow-lg"
              style={{
                backgroundImage: "url('/image/PG.png')",
                backgroundPosition: "center center",
                backgroundSize: "cover",
                backgroundRepeat: "no-repeat",
                height: "400px",
          ...
          <Link to="/" className="d-none" style={{ marginLeft: "500px" }}>
            See all reviews by our customers <FaAngleRight size={15} />{" "}
          </Link>
        </div>
      </div>
          ...
          <div className="container text-center text-md-start mt-5">
            <div className="row mt-3">
              <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                ...
                <p>
                  Access unlimited storage today! Start writing, start
                  journaling.
                </p>
              </div>

              <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                <h6 className="text-uppercase text-muted  mb-4">Company</h6>
                <p>
              ...
              <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                <h6 className="text-uppercase text-muted mb-4">Help</h6>
                <p>
                  <Link to="#" className="text-reset">
                    Customer Support
                  </Link>
                ...
                <div className="single-box">
                  <div className="input-group mb-3">
                    ...
                    <div className="col-12">
                      <Link
                        to="#"
                        className="btn btn-light mt-2 text-white px-5 py-2"
                        style={{
                          background:
                            "linear-gradient(90deg, #AA076B 0%, #61045F 100%)",
                          boxShadow: "0px 2.94px 40px rgba(40, 6, 38, 0.25)",
