  ...
  return (
    <>
      <body>
        ...
        {/* <section className="bg-opacity d-flex text-white p-5 p-lg-0 pt-lg-5 align-items-center justify-content-center">
          <div className="container">
            <div className="d-sm-flex align-items-center justify-content-center ">
              <div>
                <h3 className=" dash_text">Our Pricing</h3>
              </div>
            </div>
          </div>
        </section> */}
        ...
        <div className="container mt-5">
          <div className="row d-flex justify-content-center">
            <div className="col-lg-10 ">
              <div className="card mb-5 shadow-lg rounded">
                <div className="card-body text-center p-4">
                  <h6 className="mt-4 mb-2 price_headers"> Pricing</h6>
                  <h2 className="mb-4 clear_price">
                    {" "}
                    Simple and clear pricing
                  </h2>
                  <p className="mb-4 d-none d-lg-block text-muted">
                    {" "}
                    Having universal access to LifeJournalz is important to us.{" "}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="card mb-4 rounded-3 shadow-sm p-3">
                  <div className="card-body">
                    ...
                    <ul className="list-unstyled mt-3 mb-4 price_list">
                      ...
                      <li className="price_list">
                        Unlimited Storage of inidividual data
                      </li>
                      <li className="price_list">24/7 customer support</li>
                    </ul>
                    <Link
            ...
            <div className="container text-start text-md-start mt-5">
              <div className="row mt-3">
                ...
                <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                  <h6 className="text-uppercase link_heading mb-4">
                    Newsletter
                  </h6>
